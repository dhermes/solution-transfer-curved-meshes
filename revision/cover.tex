...
Done. The nodes at \(t = 0.0\) have been colored blue, the nodes at \(t = 0.5\)
colored purple and the nodes at \(t = 1.0\) colored black. These colors remain
associated with the nodes in each frame.
...
spaced in parameter space) along edge to better reflect the curvature while
still keeping the image size small.
